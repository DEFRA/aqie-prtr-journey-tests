...
export const config = {
  ...
  baseUrl: `https://aqie-prtr-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `aqie-prtr-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `aqie-prtr-journey-tests-${process.env.ENVIRONMENT}`
        },
