...
export const config = {
  ...
  exclude:
    ...
    [
      ...
      './test/specs/PRTR2015DataValidation.js'
    ],
  ...
  baseUrl: `https://aqie-prtr-frontend.${process.env.ENVIRONMENT}.cdp-int.defra.cloud/uk-pollutant-release-and-transfer-register/en`,
